...
# Loading SS1
load('/lab-share/RC-Data-Science-e2/Public/Daniel/p147-scRNAseq-Koehler/SS3.RData')
SS3 <- F5Data
X <- X[,colnames(SS3)]
SS3 <- SS3[,colnames(X)]
...
VF <- getVectorField(SS3,V, reduction = 'umap', resolution = 60)

save(VF, file = 'scVelo_SS3.RData')
