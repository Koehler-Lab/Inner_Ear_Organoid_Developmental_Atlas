...
# save(P147D100, Label1, Label2, matchColors2, LabelPosition, tpColors, ctColors, file = 'P147D100_Wouter.RData')
...
png('umapSS3-3.png', width = 1500, height = 1500, res = 300)
UMAPPlot(F5Data) +
theme_light() +
theme(legend.position = 'bottom', 
        panel.grid = element_blank(),
...
png('umapSS3-4.png', width = 1500, height = 1500, res = 300)
UMAPPlot(F5Data) +
theme_light() +
theme(legend.position = 'bottom', 
        panel.grid = element_blank(),
...
png('F5-M-1.png', height = 500*2, width = 500*5, res = 300)
F5PA1 <- plot_density(F5Data, c('PHOX2B'), reduction = 'umap', size = 1)
F5PA2 <- plot_density(F5Data, c('NEUROG2'), reduction = 'umap', size = 1)
F5PB1 <- plot_density(F5Data, c('PRDM12'), reduction = 'umap', size = 1)
F5PB2 <- plot_density(F5Data, c('ADAMTS6'), reduction = 'umap', size = 1)
F5PC1 <- plot_density(F5Data, c('GPM6A'), reduction = 'umap', size = 1)
F5PC2 <- plot_density(F5Data, c('POU3F2'), reduction = 'umap', size = 1)
F5PD1 <- plot_density(F5Data, c('FGF8'), reduction = 'umap', size = 1)
F5PD2 <- plot_density(F5Data, c('PAX2'), reduction = 'umap', size = 1)
F5PE1 <- plot_density(F5Data, c('S100A1'), reduction = 'umap', size = 1)
F5PE2 <- plot_density(F5Data, c('S100A13'), reduction = 'umap', size = 1)
...
png('F5-M3-1.png', width = 750*2, height = 750*2, res = 300)
plot_density(F5Data, c('NEUROG1', 'NEUROD1', 'ISL1', 'PRPH'), reduction = 'umap', size = 1) &
theme_void() &
xlim(c(3,11)) & 
ylim(c(-11,-4)) & 
theme(panel.grid = element_blank(), 
...
png('V-1.png', width = 1800, height = 1800, res = 300)
...
png('V-2.png', width = 1800, height = 1800, res = 300)
UMAPPlot(P147D100, label = FALSE) +
scale_color_manual(values = matchColors2[levels(Idents(P147D100))]) +
theme_void() +
theme(legend.position = 'None', 
...
png('V-3.png', width = 1800, height = 1800, res = 300)
UMAPPlot(P147D100, label = FALSE) +
scale_color_manual(values = matchColors2[levels(Idents(P147D100))]) +
theme_void() +
theme(legend.position = 'None', 
...
png('V-4.png', width = 1800, height = 1800, res = 300)
UMAPPlot(P147D100, label = FALSE) +
scale_color_manual(values = matchColors2[levels(Idents(P147D100))]) +
theme_void() +
theme(legend.position = 'None', 
...
png('V-5.png', width = 1800, height = 1800, res = 300)
UMAPPlot(P147D100, label = FALSE) +
scale_color_manual(values = matchColors2[levels(Idents(P147D100))]) +
theme_void() +
theme(legend.position = 'None', 
...
png('V-6.png', width = 1800, height = 1800, res = 300)
UMAPPlot(P147D100, label = FALSE) +
scale_color_manual(values = matchColors2[levels(Idents(P147D100))]) +
theme_void() +
theme(legend.position = 'None', 
...
png('umapSS1-3.png', width = 1500, height = 1500, res = 300)
UMAPPlot(SS1) +
theme_light() +
theme(legend.position = 'bottom', 
        panel.grid = element_blank(),
...
png('umapSS1-4.png', width = 1500, height = 1500, res = 300)
UMAPPlot(SS1) +
theme_light() +
theme(legend.position = 'bottom', 
        panel.grid = element_blank(),
...
png('umapSS2-3.png', width = 1500, height = 1500, res = 300)
UMAPPlot(SS2) +
theme_light() +
theme(legend.position = 'bottom', 
        panel.grid = element_blank(),
...
png('umapSS2-4.png', width = 1500, height = 1500, res = 300)
UMAPPlot(SS2) +
theme_light() +
theme(legend.position = 'bottom', 
        panel.grid = element_blank(),
...
png('F6-M1-1.png', width = 2200, height = 650, res = 300)
plot_density(F6Data, 
c('SOX2', 'OTOG', 'USH1C'), 
reduction = 'umap', size = 1) &
xlab('UMAP 1') &
ylab('UMAP 2') &
theme_void() & 
theme(panel.grid = element_blank(), 
...
png('F6-M2-1.png', width = 2200, height = 650, res = 300)
plot_density(F6Data, 
c('DLX5', 'LMX1A', 'WNT2B'), 
reduction = 'umap', size = 1) &
xlab('UMAP 1') &
...
png('F6-M3-1.png', width = (2200/3)*2, height = 650*2, res = 300)
plot_density(F6Data, 
c('ATOH1', 'POU4F3', 'OCM', 'ANXA4'), 
reduction = 'umap', size = 1) &
xlab('UMAP 1') &
...
png('DE_ISL1-PAX8-1.png', width = 1900*0.75, height = 1900*0.75, res = 300)
ggplot(DE, aes(avg_log2FC, -log10(p_val), label = label)) +
geom_point(color = DE$color, shape = DE$shape) +
geom_text_repel(
        fontface = 3, 
