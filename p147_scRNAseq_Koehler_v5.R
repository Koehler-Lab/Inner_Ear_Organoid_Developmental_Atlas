...
png('P3F-1.png', width = 1000*1*0.8, height = 1000*0.8, res = 300)
...
'KRT4', 'HAND1', 
png('P3F-2.png', width = 1000*3*0.8, height = 1000*3*0.8, res = 300)
...
png('F6-M3.png', width = 1466, height = 650*2, res = 300)
plot_density(F6Data, 
